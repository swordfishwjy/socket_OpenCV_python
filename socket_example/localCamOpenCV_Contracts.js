...
var pyscript1 = './pythonScript/captureimage.py';
var pyscript2 = './pythonScript/processimage.py';

// nodejs会等待python执行完毕
// nodejs waits for the end of the python script
var data = exec('python'+' '+pyscript1).toString();
var obj = JSON.parse(data);
console.log("Image is captured and saved. Path: ./pythonScript/caputre.png\n");
console.log("*************************************");
console.log("Sending image process request.....");
console.log('Account(IoT device):',obj.account);
console.log('Working Mode:',obj.mode);
console.log('Image Name:',obj.imageName);
console.log("*************************************");

// exec('python'+' '+pyscript1, function(err,stdout,stderr){
//   if(err){
//       console.log('error');
//   }
//
...
if( trustLevel != 4 ){
  ...
  console.log("*************************************");
  var result = exec('python'+' '+pyscript2).toString();
...
// nodejs运行一个python子程序，以json形式返回数据。
// var arg1 = 'hello';
// var arg2 = 'world';
